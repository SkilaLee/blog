...
--
-- Host: localhost
-- Generation Time: 2015-03-02 09:59:21
-- 服务器版本： 5.5.20-log
-- PHP Version: 5.3.10
...
(665628, '-,-', 3, '我不难过', 'about study', 'by 孙燕姿\r\n手都冻僵了,卧槽', '2015-03-01 13:16:08'),
...
`user_id` int(5) NOT NULL,
  ...
  `content` text NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=665630 DEFAULT CHARSET=utf8;
...
(665627, '228c513ab986d905c49ba7aace285978', '程诗韵', '2015-03-01 09:56:52', ''),
(665628, '1fd7aee6c9dd2f1dc572a1fdbc7d84e3', '-,-', '2015-03-01 13:15:30', ''),
(665629, '1fd7aee6c9dd2f1dc572a1fdbc7d84e3', 'skila', '2015-03-02 06:55:36', '');
...
INSERT INTO `discuss` (`discuss_id`, `user_id`, `friend_id`, `user_name`, `friend_name`, `content_id`, `discuss`, `time`) VALUES
(3, 665628, 665626, '-,-', 'zy', 2, '旷安宅窘状南空', '2015-03-01 13:54:54');
...
INSERT INTO `reply` (`discuss_id`, `user_id`, `user_name`, `friend_id`, `friend_name`, `reply`, `time`, `reply_id`) VALUES
(1, 665628, '-,-', 665628, '-,-', '农开局浓度亚赛', '2015-03-01 13:29:10', 1),
(2, 665628, '-,-', 665628, '-,-', '也当不了学婊...', '2015-03-01 13:44:57', 2);
...
--
ALTER TABLE `blog_user`
MODIFY `user_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=665630;
--
-- AUTO_INCREMENT for table `discuss`
--
ALTER TABLE `discuss`
MODIFY `discuss_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
